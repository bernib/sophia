		...
		<article class="Articulo">
			<div class="Autor">
				<figure>
					...
					<figcaption>POR <strong>Cristina Miguens</strong> - <a href="#">Punto de vista</a></figcaption>
				</figure>
			</div>
			<div class="Head">
			...
			<section class="Nota">
				<div class="Imagen">
					...
					<img src="images/columnistas/pic-01.jpg" width="770" height="421" alt=""/>
					<div class="CaptionBar">
						...
						<span class="Caption">Vientos de cambio</span>
					</div>
				</div>
